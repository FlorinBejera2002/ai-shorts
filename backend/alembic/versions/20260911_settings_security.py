"""Add complete account settings, session, MFA and audit state.
...
def downgrade() -> None:
    op.execute("""
    ALTER TABLE social_accounts DROP COLUMN token_expires_at;
    ALTER TABLE social_accounts DROP COLUMN scopes;
    DROP TABLE account_data_exports;
    DROP TABLE account_security_events;
    DROP TABLE account_mfa;
    DROP TABLE account_preferences;
    DROP INDEX ix_sessions_user_activity;
