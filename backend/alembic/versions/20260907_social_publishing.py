"""Encrypted social connections and durable direct publishing jobs."""
...
def downgrade() -> None:
    op.execute("DROP TABLE social_posts; DROP TABLE social_oauth_states; DROP TABLE social_accounts; ALTER TABLE clips DROP COLUMN contains_platform_badge;")
