...
export function validateCloudflareEnvironment(environment) {
  ...
  for (const key of ['DATABASE_URL', 'DIRECT_URL', 'REDIS_URL', 'AUTH_SECRET', 'NEXTAUTH_SECRET', 'INTERNAL_API_KEY', 'JWT_SECRET', 'GOOGLE_CLIENT_SECRET', 'STRIPE_SECRET_KEY', 'STRIPE_WEBHOOK_SECRET', 'UPLOAD_TOKEN_SECRET', 'GEMINI_API_KEY', 'RESEND_API_KEY', 'SMTP_PASSWORD', 'AWS_ACCESS_KEY_ID', 'AWS_SECRET_ACCESS_KEY', 'AWS_SESSION_TOKEN', 'UPLOAD_POST_API_KEY']) {
